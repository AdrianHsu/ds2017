...
# written by PIN-CHUN HSU
# this is my reference code: https://github.com/geifmany/cifar-vgg

# the architecture is based on the VGG-16 [1] 
# with adaptation to CIFAR datasets based on [2]. 
# References:
...
class vgg16:
    ...
    def build_model(self):
        ...
        # by PIN-CHUN: see this picture for the VGG16 model
        ...
        # FC1, densely-connected NN layer
        model.add(Flatten()) 
...
if __name__ == '__main__':
    ...
    # Keras: Dataset of 50,000 32x32 color training images, labeled over 10 categories, and 10,000 test images. We don't need to split by ourselves!
    (x_train, y_train), (x_test, y_test) = cifar10.load_data()
    x_train = x_train.astype('float32')
    x_test = x_test.astype('float32')
